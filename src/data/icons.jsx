export const icons = [
  ...
  >
    <path
      ...
      strokeWidth="32"
    />
    <circle fill="#fcfcfc" cx="144" cy="208" r="32" />
    <circle fill="#fcfcfc" cx="152" cy="311" r="32" />
    <circle fill="#fcfcfc" cx="224" cy="144" r="32" />
    <circle fill="#fcfcfc" cx="256" cy="367" r="48" />
    <circle fill="#fcfcfc" cx="328" cy="144" r="32" />
  </svg>,
  //
  <svg
    xmlns="http://www.w3.org/2000/svg"
